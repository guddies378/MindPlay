...
export default function ReactionRushPage() {
  ...
  function finishGame(finalScore: number, finalHistory: number[]) {
    clearTimer();

    const average =
      finalHistory.length > 0
        ? Math.round(
            finalHistory.reduce((sum, value) => sum + value, 0) /
              finalHistory.length
          )
        : 0;
    ...
    const speedBonus =
      best > 0 && best <= config.target ? 25 : 0;

    const totalXP =
      config.xp + scoreBonus + speedBonus;
  ...
  function handleBoardClick() {
    ...
    const roundScore = getReactionScore(reaction);
    const nextScore = score + roundScore;
    const nextHistory = [...history, reaction];
    ...
    if (round >= config.rounds) {
      finishGame(nextScore, nextHistory);
      return;
    }
      ...
      <div className="mx-auto max-w-5xl">
        ...
        <section className="mp-fade-up mb-8 text-center">
          ...
          <p className="mx-auto mt-3 max-w-xl text-sm leading-6 text-white/40">
            Wait for the signal. Then react as fast as possible.
            But don't click early.
          </p>
        </section>
            ...
            {gameState === "idle" && (
              <div className="py-10 text-center sm:py-14">
                ...
                <p className="mx-auto mt-2 max-w-md text-sm leading-6 text-white/35">
                  The screen will tell you when to click.
                  Don't click before it turns green.
                </p>
                ...
                {falseStart ? (
                  <>
                    ...
                    <p className="mx-auto mt-3 max-w-md text-sm leading-6 text-white/35">
                      ...
                      Stay focused and wait for green.
                    </p>
                  ...
                  <>
                    ...
                    <p className="mt-1 text-5xl font-black text-cyan-300 sm:text-6xl">
                      {formatReaction(reactionTime)}
                    </p>

                    <p className="mt-3 text-sm font-bold text-white/35">
                      {reactionTime !== null &&
                      reactionTime <= config.target
                        ? "🔥 Target beaten!"
                        : "Keep pushing!"}
                    </p>
                ...
                <div className="mx-auto mt-8 grid max-w-2xl grid-cols-2 gap-3 sm:grid-cols-4">
                  ...
                  <div className="rounded-3xl border border-white/[0.07] bg-white/2.5 p-5">
                    ...
                    <p className="mt-2 text-2xl font-black text-white">
                      {formatReaction(averageReaction)}
                    </p>
                  </div>
        ...
        <section className="mt-6 grid gap-3 sm:grid-cols-3">
          <div className="rounded-3xl border border-white/[0.07] bg-white/2.5 p-5">
            ...
            <p className="mt-1 text-xs leading-5 text-white/30">
              Don't stare at the button. Watch for the signal.
            </p>
          </div>
          ...
          <div className="rounded-3xl border border-white/[0.07] bg-white/2.5 p-5">
            ...
            <p className="mt-1 text-xs leading-5 text-white/30">
              Clicking early means you lose the round.
            </p>
          </div>
          ...
          <div className="rounded-3xl border border-white/[0.07] bg-white/2.5 p-5">
            ...
            <p className="mt-1 text-xs leading-5 text-white/30">
              Your real opponent is your previous best.
            </p>
          </div>
        </section>
