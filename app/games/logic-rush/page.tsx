...
const PUZZLES: Record<Difficulty, Puzzle[]> = {
  Easy: [
    ...
    },
    {
      ...
      options: ["2", "4", "7", "8"],
      answer: 2,
      explanation: "2, 4, and 8 are even. 7 is odd.",
    },
    {
      ...
      answer: 0,
      explanation: "If A belongs to B and B belongs to C, A belongs to C.",
    },
    {
      question: "A clock shows 3:00. What angle is between the hands?",
      options: ["45°", "60°", "90°", "180°"],
      answer: 2,
      explanation: "At 3:00 the hands form a right angle.",
    },
    {
      question: "Which is the smallest?",
      options: ["0.5", "0.05", "0.15", "0.25"],
      answer: 1,
      explanation: "0.05 is smaller than all the other values.",
    },
    {
    ...
    },
    {
      ...
      options: ["1", "2", "3", "5"],
      answer: 1,
      explanation: "You took 2 apples, so you have the 2 apples you took.",
    },
    {
  ...
  Normal: [
    ...
    },
    {
      ...
      options: ["28", "30", "32", "36"],
      answer: 1,
      explanation: "The differences are +4, +6, +8, so the next is +10.",
    },
    {
      question: "A farmer has 10 sheep. All but 3 run away. How many remain?",
      options: ["3", "7", "10", "0"],
      answer: 0,
      explanation: "\"All but 3\" means 3 sheep remain.",
    },
    {
      question: "Which number replaces ? 4, 9, 16, 25, ?",
      options: ["30", "32", "36", "49"],
      answer: 2,
      explanation: "These are squares: 2², 3², 4², 5², 6².",
    },
    {
      question: "If yesterday was Monday, what day is tomorrow?",
      options: ["Monday", "Tuesday", "Wednesday", "Thursday"],
      answer: 2,
      explanation: "If yesterday was Monday, today is Tuesday and tomorrow is Wednesday.",
    },
    {
    ...
    },
    {
      ...
      answer: 0,
      explanation: "The ball costs $0.05 and the bat costs $1.05.",
    },
    {
    ...
    },
    {
      ...
      options: ["0", "1", "2", "6"],
      answer: 1,
      explanation: "Each number is divided by 3.",
    },
    {
    ...
    {
      question: "A train travels 60 km in 1 hour. How far does it travel in 3 hours?",
  ...
  Hard: [
    {
      ...
      options: ["25", "31", "33", "35"],
      answer: 2,
      explanation: "Each term is multiplied by 2, then 1 is subtracted.",
    },
    {
      question: "What comes next? 1, 4, 10, 22, 46, ?",
      options: ["82", "90", "94", "96"],
      answer: 2,
      explanation: "Each term is multiplied by 2 and then 2 is added.",
    },
    {
      question: "You have 8 identical-looking balls. One is heavier. What is the minimum number of balance-scale weighings needed to guarantee finding it?",
      options: ["1", "2", "3", "4"],
      answer: 2,
      explanation: "Split into groups and use a maximum of 3 weighings to guarantee the answer.",
    },
    {
      question: "A clock gains 5 minutes every hour. If it is correct at noon, what will it show at 6 PM?",
      options: ["6:05 PM", "6:15 PM", "6:30 PM", "7:00 PM"],
      answer: 2,
      explanation: "It gains 5 minutes × 6 hours = 30 minutes.",
    },
    {
      question: "What number replaces ? 3, 8, 15, 24, 35, ?",
      options: ["42", "46", "48", "50"],
      answer: 2,
      explanation: "The pattern is n² − 1: 2²−1, 3²−1, 4²−1, etc.",
    },
    {
      question: "A room has 4 corners. A cat sits in each corner. Each cat sees 3 cats. How many cats are there?",
      options: ["4", "8", "12", "16"],
      answer: 0,
      explanation: "There is one cat in each of the 4 corners.",
    },
    {
      question: "What comes next? 7, 10, 16, 28, 52, ?",
      options: ["76", "88", "100", "104"],
      answer: 3,
      explanation: "The differences double: +3, +6, +12, +24, then +48.",
    },
    {
      question: "A father is 4 times as old as his son. In 20 years, he will be twice as old. How old is the son now?",
      options: ["5", "10", "15", "20"],
      answer: 1,
      explanation: "If the son is 10, father is 40. In 20 years they are 30 and 60.",
    },
    {
      question: "Which number should replace ? 121, 144, 169, ?",
      options: ["181", "196", "200", "225"],
      answer: 1,
      explanation: "These are 11², 12², 13², so the next is 14² = 196.",
    },
    {
    ...
    {
      question: "You overtake the person in 2nd place during a race. What position are you in?",
      options: ["1st", "2nd", "3rd", "Depends"],
      answer: 1,
      explanation: "You take the position of the person you overtook: 2nd.",
    },
    {
      question: "What comes next? 4, 7, 13, 25, 49, ?",
      options: ["73", "81", "97", "101"],
      answer: 2,
      explanation: "Each number is multiplied by 2 and then 1 is subtracted.",
    },
  ],
};
...
export default function LogicRushPage() {
  ...
  const currentPuzzle = questionSet[round - 1];
  ...
  function startGame() {
    const puzzles = shuffle(PUZZLES[difficulty]).slice(
      0,
      config.rounds
    );
  ...
  function handleAnswer(answerIndex: number | null) {
    ...
    const isCorrect =
      answerIndex !== null &&
      answerIndex === currentPuzzle.answer;
  ...
  function finishGame() {
    const scoreBonus = Math.min(50, Math.floor(score / 50));
    ...
    const totalXP =
      config.baseXP + scoreBonus + comboBonus;
  ...
  const accuracy =
    config.rounds > 0
      ? Math.round((correct / config.rounds) * 100)
      : 0;

  const multiplier = Math.min(
    2,
    1 + Math.floor(combo / 3) * 0.25
  );

  const timerPercentage =
    (timeLeft / config.timeLimit) * 100;
      ...
      <div className="mx-auto max-w-3xl">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="mx-auto mt-3 max-w-xl text-sm leading-6 text-white/50">
            Solve fast. Build your combo. Don't let the clock
            win.
          </p>
        </div>
          ...
          <section className="mp-card rounded-3xl p-6 sm:p-8">
            ...
            <div className="mb-7 rounded-2xl border border-white/10 bg-white/2.5 p-5">
              ...
              <ul className="mt-3 space-y-2 text-sm leading-6 text-white/50">
                ...
                <li>• Build combos for bigger multipliers.</li>
              </ul>
            </div>
        ...
        {gameState !== "menu" && gameState !== "finished" && (
          <>
            ...
            {/* FEEDBACK */}
            {gameState === "feedback" && currentPuzzle && (
              <section className="mp-card rounded-3xl p-6 sm:p-8">
        ...
        {gameState === "finished" && (
          <section className="mp-card rounded-3xl p-6 sm:p-8">
            <div className="text-center">
              ...
              <p className="mt-2 text-sm text-white/45">
                You made it through the entire logic gauntlet.
              </p>
            </div>
